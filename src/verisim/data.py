...
LITE_COUNTRY_CODES = ("US", "GB", "CA", "AU", "IN", "DE", "MX", "JP", "FR", "BR", "CN")
LITE_LOCALES = (
    ("en_US", "latin"),
    ("en_GB", "latin"),
    ("en_CA", "latin"),
...
class IndustryData:
    ...
    product_name_templates: tuple[str, ...] = ()
    product_modifiers: tuple[str, ...] = ()
    product_nouns: tuple[str, ...] = ()
    product_features: tuple[str, ...] = ()
    product_description_templates: tuple[str, ...] = ()
...
def _country_defaults(
    ...
    defaults = {
        ...
        "MX": (
            "Mexico",
            "+52",
            ("Reforma", "Juarez", "Hidalgo", "Independencia", "Insurgentes"),
            ("Calle", "Avenida", "Privada", "Calzada", "Circuito"),
        ),
        "JP": (
            "Japan",
            "+81",
            ("Chuo", "Sakura", "Meiji", "Aoyama", "Showa"),
            ("Dori", "Machi", "Avenue", "Street", "Lane"),
        ),
        "FR": (
            "France",
            "+33",
            ("Republique", "Victor Hugo", "Jean Jaures", "Pasteur", "Gare"),
            ("Rue", "Avenue", "Boulevard", "Impasse", "Place"),
        ),
        "BR": (
            "Brazil",
            "+55",
            ("Paulista", "Getulio Vargas", "Brasil", "Liberdade", "Amazonas"),
            ("Rua", "Avenida", "Travessa", "Alameda", "Praca"),
        ),
        "CN": (
            "China",
            "+86",
            ("Renmin", "Zhongshan", "Jiefang", "Chang'an", "Heping"),
            ("Road", "Avenue", "Street", "Lane", "Boulevard"),
        ),
    }
    return defaults.get(
        country_code,
        ...
        self.industries = (
            IndustryData(
                ...
                product_name_templates=(
                    ...
                    "{company} {modifier} Cloud",
                    "{company} {noun} Platform",
                ),
                product_modifiers=(
                    "Signal",
                    "Vector",
                ...
                product_features=(
                    ...
                    "self-serve metric definitions",
                    "governed workspace access",
                ),
                product_description_templates=(
                    "{product} helps {target_departments} teams at growing "
                    "companies run dependable {category} workflows.",
                    "{company} packages {industry} expertise into {product}, "
                    "a {category} offering for operational data teams.",
                ),
            ),
            IndustryData(
                ...
                product_description_templates=(
                    "{product} gives {target_departments} teams a practical "
                    "{category} layer for coordinated healthcare operations.",
                    "{company} offers {product} to help care organizations "
                    "standardize {industry} workflows.",
                ),
            ),
            IndustryData(
                ...
                product_description_templates=(
                    "{product} helps {target_departments} teams manage "
                    "{category} work with financial-grade controls.",
                    "{company} built {product} for organizations that need "
                    "dependable {industry} workflows.",
                ),
            ),
            IndustryData(
                ...
                product_description_templates=(
                    "{product} supports {target_departments} teams running "
                    "measurable {category} programs.",
                    "{company} offers {product} for organizations coordinating "
